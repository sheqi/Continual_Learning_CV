...
NUM_THREADS = 10
VIDEO_ROOT = '/home/data2/zhengwei/sth-sth-v2/20bn-something-something-v2'         # Downloaded webm videos
FRAME_ROOT = '/home/data2/zhengwei/sth-sth-v2/20bn-something-something-v2-frames'  # Directory for extracted frames
...
def extract(video, tmpl='%06d.jpg'):
    ...
    cmd = 'ffmpeg -loglevel quiet -i \"{}/{}\" -threads 1 -vf scale=-1:256 -q:v 0 \"{}/{}/%06d.jpg\"'.format(VIDEO_ROOT, video,
                                                                                             FRAME_ROOT, video[:-5])
    os.system(cmd)
