...
ROOT_DATASET = '/home/data2/zhengwei/'
# ROOT_DATASET = '/home/zhengwei/workspace/something-try/temporal-shift-module/tools'
...
def return_somethingv2(modality):
    filename_categories = 'somethingv2_annotation/category.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'sth-sth-v2/20bn-something-something-v2-frames'
        filename_imglist_train = 'somethingv2_annotation/train_videofolder.txt'
        filename_imglist_val = 'somethingv2_annotation/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
...
def return_jester(modality):
    filename_categories = ROOT_DATASET + 'jester/jester-v1-labels.csv'
    if modality == 'RGB':
        prefix = '{:05d}.jpg'
        root_data = ROOT_DATASET + 'jester/20bn-jester-v1'
        filename_imglist_train = 'jester_annotation/jester_train_videofolder.txt'
        filename_imglist_val = 'jester_annotation/jester_val_videofolder.txt'
    else:
        raise NotImplementedError('no such modality:'+modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_EgoGesture(modality):
    filename_categories = 'EgoGesture_annotation/category.txt'
    prefix = '{:06d}.jpg'
    root_data = '/home/data/egogestures'
...
def return_dataset(dataset, modality):
    dict_single = {'EgoGesture': return_EgoGesture, 'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
